    ...
    return (
        ...
        >
            <h3
                ref={titleRef}
                className={clsx(
                    "font-sans font-medium text-[20px] mb-1 relative z-10",
                    id === "rewards" ? "text-[#ff731d]" : "text-[#a0dbff]"
                )}
            >
                {text}
            </h3>
...
export const JoinnStack = ({ scrollContainerRef }: { scrollContainerRef?: React.RefObject<HTMLElement> }) => {
    ...
    opacityMap.smart = smartAccountOpacity;
    opacityMap.ai = aiInsightsOpacity;
    opacityMap.pay = payOpacity;
    opacityMap.invest = investOpacity;
    opacityMap.rewards = rewardsOpacity;
    ...
    return (
        <section
            ref={containerRef}
            className="relative w-full h-[400vh] bg-[#000C3B] snap-start"
        >
            {/* Snap markers */}
            <div className="absolute top-[20%] w-full h-px snap-start pointer-events-none" />
            <div className="absolute top-[40%] w-full h-px snap-start pointer-events-none" />
            <div className="absolute top-[60%] w-full h-px snap-start pointer-events-none" />
            <div className="absolute top-[80%] w-full h-px snap-start pointer-events-none" />

            <div className="sticky top-0 h-screen w-full flex items-center justify-center overflow-hidden">

                {/* Fixed 1440x900 Coordinate System */}
                <div
                    ref={coordContainerRef}
                    className="relative w-[1440px] h-[900px] flex-none origin-center transform transition-transform duration-300 scale-[0.25] min-[375px]:scale-[0.28] sm:scale-[0.45] md:scale-[0.6] lg:scale-[0.8] xl:scale-100"
                >

                    {/* Header */}
                    <div className="absolute top-[140px] left-0 w-full text-center">
                        <h2 className="text-[34px] font-sans text-[#a0dbff] leading-none">
                            The Joinn <span className="font-bold">Stack.</span>
                        </h2>
                        <p className="text-[26px] font-sans text-white mt-1 leading-tight">How money compounds — end to end.</p>
                    </div>

                    {/* === DYNAMIC WHITE LINES (Scroll-triggered) === */}
                    ...
                    <TreeLabel
                        ...
                        text="Joinn Rewards"
                        text1="Real-world benefits earned from consistent usage, smarter habits, and compounding behavior."
                        className="left-[140px] top-[316px] w-[250px]"
                        opacity={rewardsOpacity}
                    />

                    {/* === TREE SVG === */}
                    <div ref={treeRef} className="absolute top-[290px] left-1/2 -translate-x-1/2 w-[419px] h-[477px]">
                        <svg width="419" height="477" viewBox="0 0 419 477" fill="none" xmlns="http://www.w3.org/2000/svg">
                            {/* STAGE 1: ROOTS */}
                            <motion.g style={{ opacity: smartAccountOpacity }}>
                            ...
                            {/* STAGE 2: TRUNK */}
                            <motion.g style={{ opacity: aiInsightsOpacity }}>
                            ...
                            <motion.g style={{ opacity: payOpacity }}>
                            ...
                            <motion.g style={{ opacity: investOpacity }}>
                            ...
                            {/* STAGE 5: FRUITS */}
                            <motion.g style={{ opacity: rewardsOpacity }}>
